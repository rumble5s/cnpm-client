  ...
  return (
    <div className="antialiased bg-gray-50 dark:bg-gray-900">
      <nav className="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
        <div className="flex flex-wrap justify-between items-center">
          <div className="flex justify-start items-center">
            ...
            <a href="/admin" className="flex items-center justify-between mr-4">
          ...
          <ul className="space-y-2">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">Tin nhắn</span>
          ...
          <ul className="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
            ...
            <li>
              ...
              >
                ...
                <span className="ml-3">Ký quỹ</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span className="ml-3">Trợ giúp</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <main className="p-4 md:ml-64 h-auto pt-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4 mt-5">
          <a
            href="#"
        ...
        <div className="relative overflow-x-auto border-2 rounded-lg border-gray-400 dark:border-gray-600 h-96 mb-4">
